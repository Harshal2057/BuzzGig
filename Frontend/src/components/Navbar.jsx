...
import { Home, Search, BookOpen, User, Phone , BriefcaseBusinessIcon } from "lucide-react";
...
const Navbar = () => {
  ...
  { label: "Find work", icon: <BriefcaseBusinessIcon size={30} />, onClick: () => console.log("Profile") },
  { label: "profile", icon: <User size={30} />, onClick: () => console.log("Profile") },
